...
class SaxoTokenManager:
    ...
    async def get_access_token(self) -> str:
        ...
        if (self._bundle.access_token is None) or (self._bundle.expires_at is None) or (self._bundle.seconds_left is not None and self._bundle.seconds_left < 30):
    ...
    async def _loop(self):
        ...
        while self.auto_refresh:
            try:
                ...
                sleep_s = max(30, (self._bundle.seconds_left or 120))
